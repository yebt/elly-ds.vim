...
let s:palette.c02       = {"gui": {"dark": "#B1CE6E"}, "cterm": {"dark": " 66"}}
" let s:palette.c03       = {"gui": {"dark": "#9B9257"}, "cterm": {"dark": "100"}}
let s:palette.c03       = {"gui": {"dark": "#BFB577"}, "cterm": {"dark": "100"}}
" let s:palette.c04       = {"gui": {"dark": "#63768A"}, "cterm": {"dark": "117"}}
let s:palette.c04       = {"gui": {"dark": "#9DC2E9"}, "cterm": {"dark": "117"}}
" let s:palette.c05       = {"gui": {"dark": "#738C9C"}, "cterm": {"dark": " 23"}}
let s:palette.c05       = {"gui": {"dark": "#8AACC1"}, "cterm": {"dark": " 23"}}
" let s:palette.c05       = {"gui": {"dark": "#73B4DC"}, "cterm": {"dark": " 23"}}
" let s:palette.c06       = {"gui": {"dark": "#6998B3"}, "cterm": {"dark": " 75"}}
let s:palette.c06       = {"gui": {"dark": "#7DC9F5"}, "cterm": {"dark": " 75"}}
" let s:palette.c07       = {"gui": {"dark": "#9A9A9A"}, "cterm": {"dark": "248"}}
let s:palette.c07       = {"gui": {"dark": "#c4c4c4"}, "cterm": {"dark": "248"}}
" let s:palette.c08       = {"gui": {"dark": "#868B8D"}, "cterm": {"dark": "248"}}
let s:palette.c08       = {"gui": {"dark": "#BCC5C9"}, "cterm": {"dark": "248"}}
" let s:palette.bk00      = {"gui": {"dark": "#3E4B59"}, "cterm": {"dark": "237"}}
let s:palette.bk00      = {"gui": {"dark": "#BAC4CF"}, "cterm": {"dark": "237"}}
" let s:palette.bk01      = {"gui": {"dark": "#151A1E"}, "cterm": {"dark": "234"}}
" let s:palette.bk01      = {"gui": {"dark": "#151A1E"}, "cterm": {"dark": "234"}}
let s:palette.bk01      = {"gui": {"dark": "#192227"}, "cterm": {"dark": "234"}}
...
let s:palette.error     = {"gui": {"dark": "#FF797B"}, "cterm": {"dark": "  1"}}
...
let s:palette.diffr     = {"gui": {"dark": "#F8070B"}, "cterm": {"dark": " 52"}}
